...
public class App extends Application {
    ...
    public void start(Stage stage) {
        firstHall = new StudentHall("Torvalds Hall", 200);
        //create a gridpane
        ...
        submit.setOnAction((ActionEvent e)->{
            ...
            {
               Student myStu = new Student(txtId.getText(), txtName.getText(),txtSurname.getText(),txtAddress.getText(),txtDob.getText(),txtGender.getText());
        ...
        root.add(lblAddress,0,8);
        root.add(txtAddress,0,9);
        root.add(lblDob,0,10);
        root.add(txtDob,0,11);
        root.add(lblGender,0,12);
        root.add(txtGender,0,13);
